...
<body>	
	<link rel="stylesheet" href="/kaizens/view/global/menu/menu.css" >
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
		  ...
		  <li class="nav-item"> <a class="nav-link" href="/kaizens/view/cadastrar.php">CADASTRAR</a> </li>	 		  
		  <li class="nav-item dropdown">
			<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				CONSULTAR
			</a>
			<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				<a class="dropdown-item" href="/kaizens/view/lista.php" ><i class="fa fa-list"></i> Lista</a>												
				<a class="dropdown-item" href="/kaizens/view/painel.php" ><i class="fa fa-map-pin"></i> Painel</a>												
			</div>
		  </li>
		  <?php
