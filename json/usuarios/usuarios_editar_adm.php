...
if ($permissao == false){
    //se não é administrador de usuários, não tem acesso.
	echo '<script type="text/javascript">window.location="/classes/usuarios/usuarios_editar.php?codedit='.$_REQUEST['codedit'].'"</script>';
}
...
<head>
	...
	<script language="javascript">	
		...
		function ValidaForm(){	
            ...
            // não há validação de e-mail para administradores de usuários.
